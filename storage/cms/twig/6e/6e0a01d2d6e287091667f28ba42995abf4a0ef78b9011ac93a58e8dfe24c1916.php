...
";
            // line 19
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["record"] ?? null), "genres", [], "any", false, false, false, 19));
            foreach ($context['_seq'] as $context["_key"] => $context["genre"]) {
                // line 20
                echo "<p>
\t<a href=\"/projetTestOctoberCMS/genres/";
                // line 21
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["genre"], "slug", [], "any", false, false, false, 21), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["genre"], "name_genre", [], "any", false, false, false, 21), "html", null, true);
                echo "</a>
</p>
...
";
     ...
     <p>
      ";
            // line 30
            echo twig_get_attribute($this->env, $this->source, ($context["record"] ?? null), "description", [], "any", false, false, false, 30);
            echo " 
      </p>
...
\t\t";
            // line 35
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["record"] ?? null), "movie_gallery", [], "any", false, false, false, 35));
            foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
                // line 36
                echo "\t\t\t<img src=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["image"], "thumb", [0 => 80, 1 => ($context["auto"] ?? null)], "method", false, false, false, 36), "html", null, true);
                echo "\"/><br>
\t\t";
            }
            $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  137 => 43,  130 => 38,  121 => 36,  117 => 35,  109 => 30,  102 => 25,  90 => 21,  87 => 20,  83 => 19,  80 => 18,  71 => 16,  67 => 15,  60 => 11,  56 => 10,  48 => 6,  46 => 5,  43 => 4,  41 => 3,  39 => 2,  37 => 1,);
    }
